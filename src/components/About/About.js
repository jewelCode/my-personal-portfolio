    ...
    return (
        <div className="container">
            <div className="row">
                    ...
                    <div className="col-md-6">
                        <h1 className="text-uppercase text-primary">About Me</h1>
                        <h3 className="text-uppercase text-success">Become a Web Developer</h3>
                        ...
                        <button type="button" class="btn btn-success"> <FontAwesomeIcon icon={faDownload} /> Download My CV</button>
                    </div>
            </div>
        </div>
    );
